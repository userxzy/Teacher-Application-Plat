<template>
  <div class="dopractic">
    <div v-if="!isShow" class="selectInner">
      <a-row>
        <a-col :span="24">
          <a-button type="primary" class="mar_style" @click="addItem()"><a-icon type="plus" />添加选择题</a-button>
          <a-button type="primary" class="mar_left mar_style"><a-icon type="upload" />上传选择题</a-button>
          <a-button type="primary" class="mar_left mar_style"><a-icon type="download" />下载单选题模板</a-button>
          <a-button type="primary" class="mar_left mar_style"><a-icon type="download" />下载多选题模板</a-button>
        </a-col>
        <a-col :span="24">
    ...
    <add-select v-if="isShow" @backFun="backfun"></add-select>
  </div>
</template>
<script>
import AddSelect from '@/views/term/doterm/select/AddSelect.vue'
