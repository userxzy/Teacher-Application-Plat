...

  {
    ...
    children: [
        ...
        children: [
          {
            ...
            meta: { title: '首页', keepAlive: true, icon: 'home', permission: [ 'home' ] }
          },
          {
            path: '/dashboard/workplace',
            name: 'Workplace',
            component: () => import('@/views/dashboard/Workplace'),
            meta: { title: '工作台', keepAlive: true, permission: [ 'home' ] }
          }
        ]
      },
      ...
      // tests
      {
        ...
        name: 'tests',
        component: PageView,
        redirect: '/tests/hands',
        meta: { title: '试题管理', icon: 'table', permission: [ 'home' ] },
        children: [
          {
            path: '/tests/hands',
            name: 'hands',
            component: () => import('@/views/tests/Tests.vue'),
            meta: { title: '实操管理', keepAlive: true, permission: [ 'home' ] }
          }
        ]
      },
      ...
      // term
      {
        ...
        component: PageView,
        redirect: '/term/hands',
        meta: { title: '试题管理', icon: 'table', permisson: [ 'home' ] },
        children: [
          {
            path: '/term/hands',
            name: 'hands',
